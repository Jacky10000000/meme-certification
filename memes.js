...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // tbd
    document.getElementById('N').addEventListener('change', function (eventData) {
        let nameOutput = document.getElementById('NOutput');
        // console.log(eventData);
        nameOutput.innerText = eventData.target.value;
    });

    document.getElementById('P').addEventListener('change', function (eventData) {
    ...
    // process form Data
    document.getElementById("myForm").addEventListener("SM", function (eventData) {
